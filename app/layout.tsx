  ...
  return (
    <html lang="es">
      <head>
        ...
        <meta
          name="description"
          content="Reserva tu turno en Mundo Pádel fácil y rápido. Elegí el horario que más te convenga y asegurá tu cancha."
        />
        ...
        <meta
          ...
          content="Reserva tu turno en Mundo Pádel fácil y rápido"
        />
